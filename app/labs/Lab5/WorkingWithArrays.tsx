  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <div className="d-flex gap-2 mb-2">
        ...
        <a href={`${API}/${todo.id}/title/${todo.title}`} className="btn btn-primary float-end ms-auto">
          Update Todo</a>
      </div>
      <div className="d-flex align-items-center gap-2 mb-2">
        ...
        <a href={`${API}/${todo.id}/description/${todo.description}`} className="btn btn-primary float-end ms-auto">
      ...
      <div className="d-flex align-items-center gap-2 mb-2">
        ...
        <div className="float-start w-50">
          <input type="checkbox" className="form-check-input me-2" checked={todo.completed}
            onChange={(e) => setTodo({ ...todo, completed: e.target.checked })}/>
          <label>Completed</label>
        </div>
        <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end ms-auto">
          Update Completed</a>
      </div>
      <br /><br /><hr />
    </div>
